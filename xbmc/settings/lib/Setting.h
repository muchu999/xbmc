...
public:
  ...
  CSettingBool(std::string_view id, int label, bool value, CSettingsManager *settingsManager = nullptr);
  CSettingBool(std::string_view id, const std::string& label, bool value, CSettingsManager* settingsManager = nullptr);
...
public:
  ...
  CSettingInt(std::string_view id, int label, int value, CSettingsManager *settingsManager = nullptr);
  CSettingInt(std::string_view id, const std::string& label, int value, CSettingsManager* settingsManager = nullptr);
  CSettingInt(std::string_view id, int label, int value, int minimum, int step, int maximum, CSettingsManager *settingsManager = nullptr);
  CSettingInt(std::string_view id, const std::string& label, int value, int minimum, int step, int maximum, CSettingsManager* settingsManager = nullptr);
  CSettingInt(std::string_view id, int label, int value, const TranslatableIntegerSettingOptions &options, CSettingsManager *settingsManager = nullptr);
...
public:
  ...
  CSettingNumber(std::string_view id, int label, float value, CSettingsManager *settingsManager = nullptr);
  CSettingNumber(std::string_view id, const std::string& label, float value, CSettingsManager* settingsManager = nullptr);
  CSettingNumber(std::string_view id, int label, float value, float minimum, float step, float maximum, CSettingsManager *settingsManager = nullptr);
  CSettingNumber(std::string_view id, const std::string& label, float value, float minimum, float step, float maximum, CSettingsManager* settingsManager = nullptr);
